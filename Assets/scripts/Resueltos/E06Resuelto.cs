...
public class E06Resuelto : MonoBehaviour {
	...
	void Start () {
		...
		//bool[] nivelesCompletados_ = {false, false, false};
	...
	*/
	...
	void Start () {
		...
		string[] predicciones = {"Vas a ser un buen programador de videojuegos",
