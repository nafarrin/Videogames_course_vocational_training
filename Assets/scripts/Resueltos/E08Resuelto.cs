...
public class E08Resuelto : MonoBehaviour {
	...
	*/
	...
	void Start () {
		...
		bool falseANDtrue = false && true;		// false
	...
	*/
	...
	void Start () {
		...
		bool resultado1 = estoyProgramando && !vivoEnMarte;	// true
		bool resultado2 = vivoEnMarte || (estoyProgramando && YoutubeEmpiezaPorY);	// true
		bool resultado3 = !((!estoyProgramando || vivoEnMarte) || !YoutubeEmpiezaPorY);	// true
